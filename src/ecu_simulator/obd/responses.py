...
def configure(data: LegacyData) -> None:
    global source
    source = data
...
def get_fuel_level():
    ...
    fuel_level = validate_fuel_level(source.get_fuel_level())
...
def get_fuel_type():
    fuel_type = validate_fuel_type(source.get_fuel_type())
