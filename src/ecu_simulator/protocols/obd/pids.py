...
MODE01_DEFINITIONS: tuple[PidDefinition, ...] = (
    _definition(
        ...
        "%",
        ("engine.engine_load",),
        lambda v: _percent_to_byte(v.get("engine.engine_load")),
        1,
        CAPTURE,
    ),
    _definition(
    ...
    _definition(
        ...
        lambda v: _trim_to_byte(v.get("engine.short_fuel_trim")),
        1,
        PUBLIC,
    ),
    _definition(
        ...
        lambda v: _trim_to_byte(v.get("engine.long_fuel_trim")),
        1,
        PUBLIC,
    ),
    _definition(
        ...
        "kPa",
        ("engine.map",),
        lambda v: _byte(v.get("engine.map")),
        1,
        CAPTURE,
    ),
    _definition(
        ...
        "rpm",
        ("engine.rpm",),
        lambda v: _word(v.get("engine.rpm") * 4),
        2,
        CAPTURE,
    ),
    _definition(
    ...
    _definition(
        ...
        lambda v: _byte((v.get("engine.timing_advance") + 64.0) * 2.0),
        1,
        PUBLIC,
    ),
    _definition(
        ...
        "degC",
        ("engine.intake_temp",),
        lambda v: _temp_to_byte(v.get("engine.intake_temp")),
        1,
        PUBLIC,
    ),
    _definition(
        ...
        "g/s",
        ("engine.maf",),
        lambda v: _word(v.get("engine.maf") * 100.0),
        2,
        PUBLIC,
    ),
    _definition(
        ...
        "%",
        ("engine.throttle",),
        lambda v: _percent_to_byte(v.get("engine.throttle")),
        1,
        PUBLIC,
    ),
    _definition(
        ...
        "coded",
        ("vehicle.obd_standard",),
        lambda v: _byte(v.get("vehicle.obd_standard")),
        1,
        PUBLIC,
    ),
    _definition(
        ...
        "s",
        ("engine.runtime",),
        lambda v: _word(v.get("engine.runtime")),
        2,
        PUBLIC,
    ),
    _definition(
    ...
    _definition(
        ...
        lambda v: _word(v.get("vehicle.battery_voltage") * 1000.0),
        2,
        PUBLIC,
    ),
    _definition(
        ...
        lambda v: _temp_to_byte(v.get("vehicle.ambient_temp")),
        1,
        PUBLIC,
    ),
    _definition(
